...
| D-013 | Win32 Runner（Job Object / Restricted Token / ACL） | 进程树、限额、减权执行 | v21（SHA-256 `98964fc5...9168ce5`）已在 A4-20260810-000004 和 A5-20260810-153300 的独立 ADR-0065 签名租约下分别取得 containment 与 T05 `WIN7_PASS` | Job 不可嵌套；同用户减权不等价强沙箱；C05 仅回环观测、不提供网络隔离 | A4 containment + A5 T05 `WIN7_PASS`；允许迁移低风险非交互 Runner，产品 L01～L10 仍待验收 | ADR-0027 / ADR-0065 / ADR-0066 |
