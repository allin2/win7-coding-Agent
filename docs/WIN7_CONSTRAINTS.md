...
| D-013 | Win32 Runner（Job Object / Restricted Token / ACL） | 进程树、限额、减权执行 | v21（SHA-256 `98964fc5...9168ce5`）已在 A4-20260810-000004 的 ADR-0065 签名租约下取得 `WIN7_PASS` | Job 不可嵌套；同用户减权不等价强沙箱；C05 仅回环观测、不提供网络隔离；A5 T05 仍须独立签名租约复验 | A4 containment `WIN7_PASS`；生产迁移仍 fail-closed 待 A5 T05 | ADR-0027 / ADR-0065 / ADR-0066 |
