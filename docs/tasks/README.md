...
| [A9-09](A9_09_D013_TRUSTED_SHELL_PROFILE.md) | NATIVE_RUNTIME_HARDENING | APPROVED_FOR_IMPLEMENTATION | A9_09B_READY_FOR_LOCKED_WIN10_BUILD | WIN7_20_NOT_PERFORMED |
...
> `A9_09B_READY_FOR_LOCKED_WIN10_BUILD`。D-017 双构建、正式 v25 input lock 与 WIN7-20 实机复验未完成前，
