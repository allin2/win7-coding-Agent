...
| [A9-09](A9_09_D013_TRUSTED_SHELL_PROFILE.md) | NATIVE_RUNTIME_HARDENING | APPROVED_FOR_IMPLEMENTATION | A9_09A_BUILD_REVIEW_FIXES_PENDING_INDEPENDENT_REVIEW | WIN7_20_NOT_PERFORMED |
...
> 独立复审已撤销旧 r4 套件，当前为 `A9_09A_BUILD_REVIEW_FIXES_PENDING_INDEPENDENT_REVIEW`。再次独审、修复提交、新 revision
> 预登记和独立复核，以及 D-017 双构建、正式 v25 input lock 与 WIN7-20 实机复验未完成前，
