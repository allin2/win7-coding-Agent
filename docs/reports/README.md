...
| [A9-17 开发机启动与空闲内存实测](2026-09/a9_17_dev_memory_measurement_2026-09-12.md) | 09-12 | macOS M4 当前开发版本，空历史与 1,000 轮合成历史各 3 次；RSS 实测，不代表 Win7 或优化降幅 |
| [A9-15 WIN7-28 UI 集成验收收口报告](2026-09/a9_win7_28_ui_integration_closeout_2026-09-11.md) | 09-11 | WIN7-28 冻结身份、普通用户非提升 10/10 当前候选直接用例、真实 Provider、多阶段投影与正式 verifier；只签发 A9-15 UI 集成 PASS，不重签 Alpha/RC |
| [A9-14 WIN7-22 收口与构建基线核对](2026-09/a9_win7_22_closeout_and_build_baseline_2026-09-07.md) | 09-07 | WIN7-22 冻结 Alpha 1 裁决与后续构建基线边界 |
