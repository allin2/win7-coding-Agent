...
## 2. 当前阶段：A9-13 WIN7-19 schema v4 兼容性与新候选恢复
...
- 当前任务：`docs/tasks/A9_13_WIN7_19_SCHEMA_V4_COMPATIBILITY.md`，状态 `APPROVED_FOR_IMPLEMENTATION`；
  A9-13 只修复旧 schema v4 profile 并恢复发布门禁，既有 A9-09～A9-12 范围不重新开放。
- 交付分支：`codex/a9-win7-20-schema-v4-compat`；版本：`0.3.0-alpha.1`；目标候选：WIN7-21。
  WIN7-19 是不可变历史验收里程碑，WIN7-20 是不可变失败候选；当前综合状态仍为
  `FIX_BEFORE_ALPHA`，PR #3 在 A9-13 与 WIN7-21 G0～G7 完成前不得合并。
...
- 当前状态：ADR-0110 已授权精确兼容既有 WIN7-19 schema v4 profile，保留 v24/v25、WIN7-19 与
  WIN7-20 全部历史证据。完成独立复核、重新冻结、产品双构建和 WIN7-21 G0～G7 后，才能形成新的
  Alpha 裁决。最新事实见
...
3. 按任务需要读取架构、安全、评估、PRD、ADR 或状态文档；不要无条件加载全部历史资料。
   A9-10/A9-11/A9-12/A9-13 修复另须完整读取各自任务书。
...
| A9 当前实现授权、范围与验收 | `docs/tasks/A9_13_WIN7_19_SCHEMA_V4_COMPATIBILITY.md`、`docs/tasks/A9_TRUSTED_AGENT_RUNTIME.md`；A9-09 历史合同见 `docs/tasks/A9_09_D013_TRUSTED_SHELL_PROFILE.md` |
